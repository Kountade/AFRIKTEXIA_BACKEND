...
SECRET_KEY = "django-insecure-9ftnoe#sy3po^#^06+-!--y4_8ek%ki_zc)tr35f2luccblvz4"

# SECURITY WARNING: don't run with debug turned on in production! J
DEBUG = True


ALLOWED_HOSTS = ["afriktexia-backend-qhgj.onrender.com",
                 "localhost", "127.0.0.1"]
CSRF_TRUSTED_ORIGINS = ['https://afriktexia-backend-qhgj.onrender.com',
                        'https://afriktexia-backend-qhgj.onrender.com',]
...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://afriktexiafront.onrender.com",
    "http://localhost:3000",
    "http://127.0.0.1:3000",
]
